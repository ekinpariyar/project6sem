...
<body>
	...
	<div class="main_wrapper">
		...
		<!-- footer Start -->
		<div class="footer">
			<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif">&copy; 2023 all rights reserved | Developed By: <a href="https://www.facebook.com/ekinpariyar/">Ekinpariyar</a></h5>
		</div>
		<!-- Footer End -->
